# Exercise to understand how to create a class and use it's attributes and methods
# To create a class, first write class and the name of the class, usually first letter in Caps


class Person:
    # Function to initiate the class, with the global variables
...
def create_person_objects(names, ages, months):
    # Create the person with the attributes inserted in init function
...
def get_most_common_month(people):
    ...
    for person in people:
        months[person.birthday_month] = months.get(person.birthday_month, 0) + 1
    # Return the most common month in dictionary months
